      ...
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-white-500 sm:mb-0 dark:text-gray-400">
            ...
            <li>
              <Link to="/politicas" className="font-bold mr-4 hover:underline md:mr-6 text-black-500">Política de Privacidad</Link>
            </li>
            <li>
        ...
        <span className="font-bold block text-sm sm:text-left text-black">Musify™ 2023 - Todos los derechos reservados</span>
      </div>
    </footer>
  );
};
