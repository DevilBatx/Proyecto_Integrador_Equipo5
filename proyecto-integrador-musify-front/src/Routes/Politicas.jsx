...
const Politicas = () => {
  return (
    <div className='  w-full h-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 p-10'>
      <div>
        <h1 className='text-center text-2xl underline h-[20%] '> Terminos y condiciones de alquiler de equipamiento </h1>
        <p className='text-sm text-justify '>El tiempo mínimo de alquiler se establece en un minimo de 3 dias para acceder 
            ...
            condiciones y se hace responsable de los daños, que sufra por cualquier causa,
             ...
             <div>
             <h2 className='text-center text-2xl underline h-[20%]'>Documentacion necesaria para Alquilar</h2>
             <p className='text-sm text-justify'>La formalización del contrato de alquiler se llevará a cabo personal y 
               ...
               Para cualquier cambio, reparación o devolución deberás dirigirte al mismo
                ...
                <div>
                <h2 className='text-center text-2xl underline h-[20%] '>Cambio de instrumento</h2>
                <p className='text-sm text-justify'>Ya sea porque el instrumento alquilado no te guste y quieras probar 
