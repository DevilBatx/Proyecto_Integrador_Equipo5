  ...
  function o() {
    ...
    return ye(ke(t3 = n.call.apply(n, [this].concat(s))), "MONTH_REFS", Se(Array(12)).map(function() {
      ...
      if ("Tab" !== d && e2.preventDefault(), !s2) {
        var u = Bt(p, i2), h = At[u].verticalNavigationOffset, m = At[u].grid;
        switch (d) {
          case "Enter":
      ...
      t3.handleDayClick(Be(setQuarter(t3.props.day, r2)), e2);
    }), ye(ke(t3), "onQuarterMouseEnter", function(e2) {
      t3.handleDayMouseEnter(Be(setQuarter(t3.props.day, e2)));
...
var Qt = function(t2) {
  ...
  function n() {
    ...
    for (var o = arguments.length, a = new Array(o), i = 0; i < o; i++)
      a[i] = arguments[i];
    return ye(ke(t3 = r2.call.apply(r2, [this].concat(a))), "state", { height: null }), ye(ke(t3), "scrollToTheSelectedTime", function() {
    ...
    }), ye(ke(t3), "handleClick", function(e2) {
      ...
      var r3, n2;
    }), ye(ke(t3), "isDisabledTime", function(e2) {
...
var Ut = function(t2) {
  var r2 = t2.icon, n = t2.className, o = void 0 === n ? "" : n, a = "react-datepicker__calendar-icon";
  return import_react2.default.isValidElement(r2) ? import_react2.default.cloneElement(r2, { className: "".concat(r2.props.className || "", " ").concat(a, " ").concat(o) }) : "string" == typeof r2 ? import_react2.default.createElement("i", { className: "".concat(a, " ").concat(r2, " ").concat(o), "aria-hidden": "true" }) : import_react2.default.createElement("svg", { className: "".concat(a, " ").concat(o), xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512" }, import_react2.default.createElement("path", { d: "M96 32V64H48C21.5 64 0 85.5 0 112v48H448V112c0-26.5-21.5-48-48-48H352V32c0-17.7-14.3-32-32-32s-32 14.3-32 32V64H160V32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192H0V464c0 26.5 21.5 48 48 48H400c26.5 0 48-21.5 48-48V192z" }));
};
var zt = function(t2) {
  De(n, import_react2.default.Component);
  var r2 = be(n);
  ...
  return fe(o, [{ key: "render", value: function() {
    ...
    if (!s) {
      ...
      t3 = import_react2.default.createElement(Popper, ve({ modifiers: p, placement: c }, l), function(t4) {
        ...
        return import_react2.default.createElement(Gt, { enableTabLoop: u }, import_react2.default.createElement("div", { ref: r2, style: n3, className: y, "data-placement": o3, onKeyDown: h }, import_react2.default.cloneElement(i, { arrowProps: a2 })));
      });
    }
    this.props.popperContainer && (t3 = import_react2.default.createElement(this.props.popperContainer, {}, t3)), m && !s && (t3 = import_react2.default.createElement(zt, { portalId: m, portalHost: f }, t3));
...
var tr = function(t2) {
  ...
  function s(t3) {
    ...
    return he(this, s), ye(ke(i = a.call(this, t3)), "getPreSelection", function() {
      ...
      i.setState({ open: e2, preSelection: e2 && i.state.open ? i.state.preSelection : i.calcInitialState().preSelection, lastPreSelectChange: nr }, function() {
    ...
    }), ye(ke(i), "sendFocusBackToInput", function() {
      ...
      if (!i.props.onChangeRaw || (i.props.onChangeRaw.apply(ke(i), t4), "function" == typeof n.isDefaultPrevented && !n.isDefaultPrevented())) {
        i.setState({ inputValue: n.target.value, lastPreSelectChange: rr });
      ...
      if (i.state.open || i.props.inline || i.props.preventOpenOnFocus) {
        if (i.state.open) {
          ...
          "Enter" === t4 ? (e2.preventDefault(), i.inputOk() && i.state.lastPreSelectChange === nr ? (i.handleSelect(n, e2), !i.props.shouldCloseOnSelect && i.setPreSelection(n)) : i.setOpen(false)) : "Escape" === t4 ? (e2.preventDefault(), i.sendFocusBackToInput(), i.setOpen(false)) : "Tab" === t4 && i.setOpen(false), i.inputOk() || i.props.onInputError({ code: 1, msg: er });
        }
      } else
      ...
      if ("Enter" === t4)
        ...
        e2.preventDefault(), i.setOpen(false), i.inputOk() || i.props.onInputError({ code: 1, msg: er });
        ...
        if (!n)
          return void (i.props.onInputError && i.props.onInputError({ code: 1, msg: er }));
        if (e2.preventDefault(), i.setState({ lastPreSelectChange: nr }), i.props.adjustDateOnChange && i.setSelected(n), i.setPreSelection(n), i.props.inline) {
      ...
      var t4, n = (0, import_classnames.default)(i.props.className, ye({}, Xt, i.state.open)), o = i.props.customInput || import_react2.default.createElement("input", { type: "text" }), a2 = i.props.customInputRef || "ref", s2 = "string" == typeof i.props.value ? i.props.value : "string" == typeof i.state.inputValue ? i.state.inputValue : i.props.selectsRange ? function(e2, t5, r2) {
        if (!e2)
          return "";
  ...
  return fe(s, [{ key: "componentDidMount", value: function() {
    ...
    var t3 = this.props, r2 = t3.showIcon, n = t3.icon, o = t3.calendarIconClassname;
    ...
    if (this.props.withPortal) {
      var r2 = this.state.open ? import_react2.default.createElement(Gt, { enableTabLoop: this.props.enableTabLoop }, import_react2.default.createElement("div", { className: "react-datepicker__portal", tabIndex: -1, onKeyDown: this.onPortalKeyDown }, t3)) : null;
