...
function De(e3, t3) {
  if ("function" != typeof t3 && null !== t3)
    throw new TypeError("Super expression must either be null or a function");
  e3.prototype = Object.create(t3 && t3.prototype, { constructor: { value: e3, writable: true, configurable: true } }), Object.defineProperty(e3, "prototype", { writable: false }), t3 && we(e3, t3);
}
function ge(e3) {
...
function we(e3, t3) {
  return we = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e4, t4) {
...
var Pe = { p: Ee, P: function(e3, t3) {
  ...
  return r2.replace("{{date}}", Me(o, t3)).replace("{{time}}", Ee(a3, t3));
} };
var Ne = 12;
var xe = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g;
function Ye(e3) {
...
var Nt;
var xt = react_onclickoutside_es_default(function(t3) {
  ...
  function o(t4) {
    ...
    return he(this, o), ye(ke(r2 = n.call(this, t4)), "renderOptions", function() {
      return r2.state.monthYearsList.map(function(t5) {
        var n2 = getTime(t5), o2 = Qe(r2.props.date, t5) && He(r2.props.date, t5);
...
var Yt = function(t3) {
  ...
  function n() {
    ...
    return ye(ke(t4 = r2.call.apply(r2, [this].concat(a3))), "state", { dropdownVisible: false }), ye(ke(t4), "renderSelectOptions", function() {
      ...
      return import_react2.default.createElement(xt, { key: "dropdown", date: t4.props.date, dateFormat: t4.props.dateFormat, onChange: t4.onChange, onCancel: t4.toggleDropdown, minDate: t4.props.minDate, maxDate: t4.props.maxDate, scrollableMonthYearDropdown: t4.props.scrollableMonthYearDropdown, locale: t4.props.locale });
    }), ye(ke(t4), "renderScrollMode", function() {
      var e3 = t4.state.dropdownVisible, r3 = [t4.renderReadView(!e3)];
      return e3 && r3.unshift(t4.renderDropdown()), r3;
    }), ye(ke(t4), "onChange", function(e3) {
      ...
      Qe(t4.props.date, r3) && He(t4.props.date, r3) || t4.props.onChange(r3);
    }), ye(ke(t4), "toggleDropdown", function() {
      return t4.setState({ dropdownVisible: !t4.state.dropdownVisible });
    }), t4;
  }
...
var Tt = function(t3) {
  ...
  function o() {
    ...
    return ye(ke(t4 = n.call.apply(n, [this].concat(s3))), "dayEl", import_react2.default.createRef()), ye(ke(t4), "handleClick", function(e3) {
    ...
    }), ye(ke(t4), "getHighLightedClass", function() {
      var e3 = t4.props, r2 = e3.day, n2 = e3.highlightDates;
      if (!n2)
        return false;
      var o2 = Ie(r2, "MM.dd.yyyy");
      return n2.get(o2);
    }), ye(ke(t4), "getHolidaysClass", function() {
      ...
      return t4.isKeyboardSelected() || t4.isSameDay(n2) && We(o2, n2) ? 0 : -1;
...
var Kt = function(t3) {
  ...
  function o() {
    ...
    for (var a3 = arguments.length, s3 = new Array(a3), i2 = 0; i2 < a3; i2++)
      s3[i2] = arguments[i2];
    return ye(ke(t4 = n.call.apply(n, [this].concat(s3))), "MONTH_REFS", Se(Array(12)).map(function() {
      return import_react2.default.createRef();
    })), ye(ke(t4), "QUARTER_REFS", Se(Array(4)).map(function() {
      return import_react2.default.createRef();
      ...
      return !(!o2 || !a4) && He(setMonth(n2, e3), o2);
    }), ye(ke(t4), "isRangeStartQuarter", function(e3) {
      var r2 = t4.props, n2 = r2.day, o2 = r2.startDate, a4 = r2.endDate;
      return !(!o2 || !a4) && je(setQuarter(n2, e3), o2);
    }), ye(ke(t4), "isRangeEndMonth", function(e3) {
      var r2 = t4.props, n2 = r2.day, o2 = r2.startDate, a4 = r2.endDate;
      return !(!o2 || !a4) && He(setMonth(n2, e3), a4);
    }), ye(ke(t4), "isRangeEndQuarter", function(e3) {
      var r2 = t4.props, n2 = r2.day, o2 = r2.startDate, a4 = r2.endDate;
      return !(!o2 || !a4) && je(setQuarter(n2, e3), a4);
    }), ye(ke(t4), "isInSelectingRangeMonth", function(e3) {
    ...
    }), ye(ke(t4), "isSelectingMonthRangeStart", function(e3) {
      var r2;
      ...
      return He(i3, s4 ? p : a4);
    }), ye(ke(t4), "isSelectingMonthRangeEnd", function(e3) {
      var r2;
      if (!t4.isInSelectingRangeMonth(e3))
        return false;
      ...
      return He(p, s4 || i3 ? c2 : a4);
    }), ye(ke(t4), "isInSelectingRangeQuarter", function(e3) {
      var r2, n2 = t4.props, o2 = n2.day, a4 = n2.selectsStart, s4 = n2.selectsEnd, i3 = n2.selectsRange, p = n2.startDate, c2 = n2.endDate, l = null !== (r2 = t4.props.selectingDate) && void 0 !== r2 ? r2 : t4.props.preSelection;
    ...
    }), ye(ke(t4), "onMonthMouseEnter", function(e3) {
      ...
      if ("Tab" !== d3 && e3.preventDefault(), !s4) {
        var u2 = Bt(p, i3), h3 = At[u2].verticalNavigationOffset, m3 = At[u2].grid;
        switch (d3) {
          case "Enter":
      ...
      t4.handleDayClick(Be(setQuarter(t4.props.day, r2)), e3);
    }), ye(ke(t4), "onQuarterMouseEnter", function(e3) {
      t4.handleDayMouseEnter(Be(setQuarter(t4.props.day, e3)));
    ...
    }), ye(ke(t4), "getMonthContent", function(e3) {
    ...
    }), ye(ke(t4), "getQuarterContent", function(e3) {
      ...
      return At[Bt(o2, n2)].grid.map(function(r3, n3) {
      ...
      var e3 = t4.props, n2 = e3.selectingDate, o2 = e3.selectsStart, a4 = e3.selectsEnd, s4 = e3.showMonthYearPicker, i3 = e3.showQuarterYearPicker;
...
var Qt = function(t3) {
  ...
  function n() {
    ...
    for (var o = arguments.length, a3 = new Array(o), i2 = 0; i2 < o; i2++)
      a3[i2] = arguments[i2];
    return ye(ke(t4 = r2.call.apply(r2, [this].concat(a3))), "state", { height: null }), ye(ke(t4), "scrollToTheSelectedTime", function() {
    ...
    }), ye(ke(t4), "handleClick", function(e3) {
    ...
    }), ye(ke(t4), "liClasses", function(e3) {
      ...
      return r3.map(function(r4, o3) {
        return import_react2.default.createElement("li", { key: o3, onClick: t4.handleClick.bind(ke(t4), r4), className: t4.liClasses(r4), ref: function(e3) {
...
ye(Qt, "calcCenterPosition", function(e3, t3) {
...
var Ht = function(t3) {
  ...
  function o(t4) {
    var a3;
    return he(this, o), ye(ke(a3 = n.call(this, t4)), "YEAR_REFS", Se(Array(a3.props.yearItemNumber)).map(function() {
      return import_react2.default.createRef();
    })), ye(ke(a3), "isDisabled", function(e3) {
      return Ze(e3, a3.props);
    }), ye(ke(a3), "isExcluded", function(e3) {
      return et(e3, a3.props);
    }), ye(ke(a3), "selectingDate", function() {
      var e3;
      ...
      var r2 = a3.props, n2 = r2.date, o2 = r2.yearItemNumber, s3 = kt(n2, o2).startPeriod;
    ...
    }), ye(ke(a3), "isRangeStart", function(e3) {
      return a3.props.startDate && a3.props.endDate && Qe(setYear(Ye(), e3), a3.props.startDate);
    }), ye(ke(a3), "isRangeEnd", function(e3) {
      return a3.props.startDate && a3.props.endDate && Qe(setYear(Ye(), e3), a3.props.endDate);
    }), ye(ke(a3), "isInRange", function(e3) {
      return ot(e3, a3.props.startDate, a3.props.endDate);
    }), ye(ke(a3), "isInSelectingRange", function(e3) {
    ...
    }), ye(ke(a3), "isSelectingRangeStart", function(e3) {
      if (!a3.isInSelectingRange(e3))
        return false;
      var t5 = a3.props, r2 = t5.startDate, n2 = t5.selectsStart, o2 = setYear(Ye(), e3);
      return Qe(o2, n2 ? a3.selectingDate() : r2);
    }), ye(ke(a3), "isSelectingRangeEnd", function(e3) {
      if (!a3.isInSelectingRange(e3))
        return false;
      var t5 = a3.props, r2 = t5.endDate, n2 = t5.selectsEnd, o2 = t5.selectsRange, s3 = setYear(Ye(), e3);
      return Qe(s3, n2 || o2 ? a3.selectingDate() : r2);
    }), ye(ke(a3), "isKeyboardSelected", function(e3) {
      var t5 = Ae(setYear(a3.props.date, e3));
      return !a3.props.disabledKeyboardNavigation && !a3.props.inline && !We(t5, Ae(a3.props.selected)) && We(t5, Ae(a3.props.preSelection));
    ...
    }), ye(ke(a3), "getYearContainerClassNames", function() {
    ...
    }), ye(ke(a3), "getYearContent", function(e3) {
      return a3.props.renderYearContent ? a3.props.renderYearContent(e3) : e3;
    }), a3;
  }
  return fe(o, [{ key: "render", value: function() {
    for (var t4 = this, r2 = [], n2 = this.props, o2 = n2.date, a3 = n2.yearItemNumber, s3 = n2.onYearMouseEnter, i2 = n2.onYearMouseLeave, p = kt(o2, a3), c2 = p.startPeriod, l = p.endPeriod, d3 = function(n3) {
...
var qt = function(t3) {
  ...
  function o(t4) {
    ...
    return he(this, o), ye(ke(a3 = n.call(this, t4)), "handleClickOutside", function(e3) {
    ...
    }), ye(ke(a3), "handleCustomMonthChange", function(e3) {
    ...
    }), ye(ke(a3), "clearSelectingDate", function() {
      ...
      if (!a3.props.renderCustomHeader) {
        ...
        switch (true) {
          ...
          case a3.props.showYearPicker:
            t5 = function(e3) {
              var t6 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r3 = t6.minDate, n3 = t6.yearItemNumber, o3 = void 0 === n3 ? Ne : n3, a4 = kt(Ae(subYears(e3, o3)), o3).endPeriod, s4 = r3 && getYear(r3);
      ...
      if (!a3.props.renderCustomHeader) {
        ...
        switch (true) {
          ...
          case a3.props.showYearPicker:
            t5 = function(e3) {
              var t6 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r3 = t6.maxDate, n3 = t6.yearItemNumber, o3 = void 0 === n3 ? Ne : n3, a4 = kt(addYears(e3, o3), o3).startPeriod, s4 = r3 && getYear(r3);
              return s4 && s4 < a4 || false;
            }(a3.state.date, a3.props);
            break;
          default:
      ...
      if (a3.props.showMonthDropdown && !t5)
        return import_react2.default.createElement(Et, { dropdownMode: a3.props.dropdownMode, locale: a3.props.locale, onChange: a3.changeMonth, month: getMonth(a3.state.date), useShortMonthInDropdown: a3.props.useShortMonthInDropdown });
    }), ye(ke(a3), "renderMonthYearDropdown", function() {
      var t5 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (a3.props.showMonthYearDropdown && !t5)
        return import_react2.default.createElement(Yt, { dropdownMode: a3.props.dropdownMode, locale: a3.props.locale, dateFormat: a3.props.dateFormat, onChange: a3.changeMonthYear, minDate: a3.props.minDate, maxDate: a3.props.maxDate, date: a3.state.date, scrollableMonthYearDropdown: a3.props.scrollableMonthYearDropdown });
      ...
      var t5 = a3.state.date, r2 = a3.props, n2 = r2.showYearPicker, o2 = kt(t5, r2.yearItemNumber), s3 = o2.startPeriod, i2 = o2.endPeriod;
  ...
  return fe(o, [{ key: "componentDidMount", value: function() {
    ...
    var t4 = this;
    if (!this.props.preSelection || We(this.props.preSelection, e3.preSelection) && this.props.monthSelectedIn === e3.monthSelectedIn)
      this.props.openToDate && !We(this.props.openToDate, e3.openToDate) && this.setState({ date: this.props.openToDate });
    else {
    ...
    var t4 = this.props.container || Wt;
...
var Gt = function(t3) {
  ...
  function n(t4) {
    ...
    return he(this, n), ye(ke(o = r2.call(this, t4)), "getTabChildren", function() {
      return Array.prototype.slice.call(o.tabLoopRef.current.querySelectorAll("[tabindex], a, button, input, select, textarea"), 1, -1).filter($t);
  ...
  return fe(o, [{ key: "render", value: function() {
    ...
    if (!s3) {
      ...
      t4 = import_react2.default.createElement(Popper, ve({ modifiers: p, placement: c2 }, l), function(t5) {
        ...
        return import_react2.default.createElement(Gt, { enableTabLoop: u2 }, import_react2.default.createElement("div", { ref: r2, style: n3, className: y3, "data-placement": o3, onKeyDown: h3 }, import_react2.default.cloneElement(i2, { arrowProps: a4 })));
      });
    }
    this.props.popperContainer && (t4 = import_react2.default.createElement(this.props.popperContainer, {}, t4)), m3 && !s3 && (t4 = import_react2.default.createElement(zt, { portalId: m3, portalHost: f }, t4));
...
var Xt = "react-datepicker-ignore-onclickoutside";
var Zt = react_onclickoutside_es_default(qt);
var er = "Date input not valid.";
var tr = function(t3) {
  De(s3, import_react2.default.Component);
  var a3 = be(s3);
  function s3(t4) {
    var i2;
    return he(this, s3), ye(ke(i2 = a3.call(this, t4)), "getPreSelection", function() {
    ...
    }), ye(ke(i2), "calcInitialState", function() {
      var e3, t5, r2 = null === (e3 = i2.props.holidays) || void 0 === e3 ? void 0 : e3.reduce(function(e4, t6) {
        var r3 = new Date(t6.date);
        return isValid(r3) ? [].concat(Se(e4), [de(de({}, t6), {}, { date: r3 })]) : e4;
      }, []), n = i2.getPreSelection(), a4 = ft(i2.props), s4 = yt(i2.props), p = a4 && isBefore(n, startOfDay(a4)) ? a4 : s4 && isAfter(n, endOfDay(s4)) ? s4 : n;
      return { open: i2.props.startOpen || false, preventFocus: false, preSelection: null !== (t5 = i2.props.selectsRange ? i2.props.startDate : i2.props.selected) && void 0 !== t5 ? t5 : p, highlightDates: vt(i2.props.highlightDates), holidays: Dt(r2), focused: false, shouldFocusDayInline: false, isRenderAriaLiveMessage: false };
    }), ye(ke(i2), "clearPreventFocusTimeout", function() {
      i2.preventFocusTimeout && clearTimeout(i2.preventFocusTimeout);
    }), ye(ke(i2), "setFocus", function() {
      i2.input && i2.input.focus && i2.input.focus({ preventScroll: true });
    }), ye(ke(i2), "setBlur", function() {
      i2.input && i2.input.blur && i2.input.blur(), i2.cancelFocusInput();
    }), ye(ke(i2), "setOpen", function(e3) {
      var t5 = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
      i2.setState({ open: e3, preSelection: e3 && i2.state.open ? i2.state.preSelection : i2.calcInitialState().preSelection, lastPreSelectChange: nr }, function() {
    ...
    }), ye(ke(i2), "sendFocusBackToInput", function() {
    ...
    }), ye(ke(i2), "cancelFocusInput", function() {
      clearTimeout(i2.inputFocusTimeout), i2.inputFocusTimeout = null;
    }), ye(ke(i2), "deferFocusInput", function() {
      i2.cancelFocusInput(), i2.inputFocusTimeout = setTimeout(function() {
        return i2.setFocus();
      }, 1);
    }), ye(ke(i2), "handleDropdownFocus", function() {
      i2.cancelFocusInput();
    }), ye(ke(i2), "handleBlur", function(e3) {
      (!i2.state.open || i2.props.withPortal || i2.props.showTimeInput) && i2.props.onBlur(e3), i2.setState({ focused: false });
    }), ye(ke(i2), "handleCalendarClickOutside", function(e3) {
      i2.props.inline || i2.setOpen(false), i2.props.onClickOutside(e3), i2.props.withPortal && e3.preventDefault();
    }), ye(ke(i2), "handleChange", function() {
      for (var e3 = arguments.length, t5 = new Array(e3), r2 = 0; r2 < e3; r2++)
        t5[r2] = arguments[r2];
      var n = t5[0];
      if (!i2.props.onChangeRaw || (i2.props.onChangeRaw.apply(ke(i2), t5), "function" == typeof n.isDefaultPrevented && !n.isDefaultPrevented())) {
        i2.setState({ inputValue: n.target.value, lastPreSelectChange: rr });
        var o, a4, s4, p, c2, l, d3, u2, h3 = (o = n.target.value, a4 = i2.props.dateFormat, s4 = i2.props.locale, p = i2.props.strictParsing, c2 = i2.props.minDate, l = null, d3 = Ge(s4) || Ge($e()), u2 = true, Array.isArray(a4) ? (a4.forEach(function(e4) {
          ...
          var t6 = e4[0];
          return "p" === t6 || "P" === t6 ? d3 ? (0, Pe[t6])(e4, d3.formatLong) : t6 : e4;
        }).join(""), o.length > 0 && (l = parse(o, a4.slice(0, o.length), /* @__PURE__ */ new Date())), Te(l) || (l = new Date(o))), Te(l) && u2 ? l : null));
        i2.props.showTimeSelectOnly && i2.props.selected && !We(h3, i2.props.selected) && (h3 = set(i2.props.selected, null == h3 ? { hours: getHours(i2.props.selected), minutes: getMinutes(i2.props.selected), seconds: getSeconds(i2.props.selected) } : { hours: getHours(h3), minutes: getMinutes(h3), seconds: getSeconds(h3) })), !h3 && n.target.value || i2.setSelected(h3, n, true);
      }
    }), ye(ke(i2), "handleSelect", function(e3, t5, r2) {
      if (i2.props.shouldCloseOnSelect && !i2.props.showTimeSelect && i2.sendFocusBackToInput(), i2.props.onChangeRaw && i2.props.onChangeRaw(t5), i2.setSelected(e3, t5, false, r2), i2.props.showDateSelect && i2.setState({ isRenderAriaLiveMessage: true }), !i2.props.shouldCloseOnSelect || i2.props.showTimeSelect)
    ...
    }), ye(ke(i2), "setSelected", function(e3, t5, r2, n) {
      var o = e3;
    ...
    }), ye(ke(i2), "setPreSelection", function(e3) {
    ...
    }), ye(ke(i2), "handleTimeChange", function(e3) {
      ...
      if (i2.state.open || i2.props.inline || i2.props.preventOpenOnFocus) {
        if (i2.state.open) {
          if ("ArrowDown" === t5 || "ArrowUp" === t5) {
            e3.preventDefault();
            var r2 = i2.calendar.componentNode && i2.calendar.componentNode.querySelector('.react-datepicker__day[tabindex="0"]');
            return void (r2 && r2.focus({ preventScroll: true }));
          }
          var n = Ye(i2.state.preSelection);
          "Enter" === t5 ? (e3.preventDefault(), i2.inputOk() && i2.state.lastPreSelectChange === nr ? (i2.handleSelect(n, e3), !i2.props.shouldCloseOnSelect && i2.setPreSelection(n)) : i2.setOpen(false)) : "Escape" === t5 ? (e3.preventDefault(), i2.sendFocusBackToInput(), i2.setOpen(false)) : "Tab" === t5 && i2.setOpen(false), i2.inputOk() || i2.props.onInputError({ code: 1, msg: er });
        }
      } else
        "ArrowDown" !== t5 && "ArrowUp" !== t5 && "Enter" !== t5 || i2.onInputClick();
    }), ye(ke(i2), "onPortalKeyDown", function(e3) {
      "Escape" === e3.key && (e3.preventDefault(), i2.setState({ preventFocus: true }, function() {
        i2.setOpen(false), setTimeout(function() {
          i2.setFocus(), i2.setState({ preventFocus: false });
        });
      }));
    }), ye(ke(i2), "onDayKeyDown", function(e3) {
      i2.props.onKeyDown(e3);
      ...
      if ("Enter" === t5)
        ...
        e3.preventDefault(), i2.setOpen(false), i2.inputOk() || i2.props.onInputError({ code: 1, msg: er });
        ...
        if (!n)
          return void (i2.props.onInputError && i2.props.onInputError({ code: 1, msg: er }));
        if (e3.preventDefault(), i2.setState({ lastPreSelectChange: nr }), i2.props.adjustDateOnChange && i2.setSelected(n), i2.setPreSelection(n), i2.props.inline) {
    ...
    }), ye(ke(i2), "onPopperKeyDown", function(e3) {
      "Escape" === e3.key && (e3.preventDefault(), i2.sendFocusBackToInput());
    }), ye(ke(i2), "onClearClick", function(e3) {
    ...
    }), ye(ke(i2), "clear", function() {
      i2.onClearClick();
    }), ye(ke(i2), "onScroll", function(e3) {
    ...
    }), ye(ke(i2), "renderDateInput", function() {
      var t5, n = (0, import_classnames.default)(i2.props.className, ye({}, Xt, i2.state.open)), o = i2.props.customInput || import_react2.default.createElement("input", { type: "text" }), a4 = i2.props.customInputRef || "ref", s4 = "string" == typeof i2.props.value ? i2.props.value : "string" == typeof i2.state.inputValue ? i2.state.inputValue : i2.props.selectsRange ? function(e3, t6, r2) {
        if (!e3)
          return "";
      ...
      return import_react2.default.cloneElement(o, (ye(t5 = {}, a4, function(e3) {
        i2.input = e3;
      }), ye(t5, "value", s4), ye(t5, "onBlur", i2.handleBlur), ye(t5, "onChange", i2.handleChange), ye(t5, "onClick", i2.onInputClick), ye(t5, "onFocus", i2.handleFocus), ye(t5, "onKeyDown", i2.onInputKeyDown), ye(t5, "id", i2.props.id), ye(t5, "name", i2.props.name), ye(t5, "form", i2.props.form), ye(t5, "autoFocus", i2.props.autoFocus), ye(t5, "placeholder", i2.props.placeholderText), ye(t5, "disabled", i2.props.disabled), ye(t5, "autoComplete", i2.props.autoComplete), ye(t5, "className", (0, import_classnames.default)(o.props.className, n)), ye(t5, "title", i2.props.title), ye(t5, "readOnly", i2.props.readOnly), ye(t5, "required", i2.props.required), ye(t5, "tabIndex", i2.props.tabIndex), ye(t5, "aria-describedby", i2.props.ariaDescribedBy), ye(t5, "aria-invalid", i2.props.ariaInvalid), ye(t5, "aria-labelledby", i2.props.ariaLabelledBy), ye(t5, "aria-required", i2.props.ariaRequired), t5));
    }), ye(ke(i2), "renderClearButton", function() {
      var t5 = i2.props, r2 = t5.isClearable, n = t5.selected, o = t5.startDate, a4 = t5.endDate, s4 = t5.clearButtonTitle, p = t5.clearButtonClassName, c2 = void 0 === p ? "" : p, l = t5.ariaLabelClose, d3 = void 0 === l ? "Close" : l;
      return !r2 || null == n && null == o && null == a4 ? null : import_react2.default.createElement("button", { type: "button", className: "react-datepicker__close-icon ".concat(c2).trim(), "aria-label": d3, onClick: i2.onClearClick, title: s4, tabIndex: -1 });
  ...
  return fe(s3, [{ key: "componentDidMount", value: function() {
    ...
    return import_react2.default.createElement("div", { className: "react-datepicker__input-container".concat(r2 ? " react-datepicker__view-calendar-icon" : "") }, r2 && import_react2.default.createElement(Ut, { icon: n, className: o }), this.state.isRenderAriaLiveMessage && this.renderAriaLiveRegion(), this.renderDateInput(), this.renderClearButton());
  } }, { key: "render", value: function() {
    var t4 = this.renderCalendar();
    if (this.props.inline)
      return t4;
    if (this.props.withPortal) {
      var r2 = this.state.open ? import_react2.default.createElement(Gt, { enableTabLoop: this.props.enableTabLoop }, import_react2.default.createElement("div", { className: "react-datepicker__portal", tabIndex: -1, onKeyDown: this.onPortalKeyDown }, t4)) : null;
      return this.state.open && this.props.portalId && (r2 = import_react2.default.createElement(zt, { portalId: this.props.portalId, portalHost: this.props.portalHost }, r2)), import_react2.default.createElement("div", null, this.renderInputContainer(), r2);
    }
