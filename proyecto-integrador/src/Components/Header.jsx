        ...
        <header className='bg-orange-500 fixed top-0 left-0 right-0 top-0'>
            <div className='container mx-auto px-4 py-2 flex flex-col md:flex-row items-center justify-between'>
                <div className='flex items-center mb-2 md:mb-0'>
                    <Link to="/home"><img className='h-16 md:h-20' src={logo} alt="logoEmpresa" /></Link>
                    <div className="ml-2 md:ml-4">
                        <h1 className="text-2xl md:text-3xl font-bold text-blue">Musify</h1>
                        <p className="hidden md:block text-sm text-blue">Donde la música y la pasión se encuentran</p>
                    </div>
                </div>
