        ...
        <div className="w-full max-w-sm bg-white flex flex-col items-center gap-1 p-1">
            ...
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center justify-between">
                    <Link to="/guitarras" className="text-white bg-orange-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-1.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Ver mas
                    </Link>
                </div>
            </div>
