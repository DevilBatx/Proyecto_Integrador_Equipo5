...
import Bateria from '../assets/Products/Bateria.png';
    ...
    <div className="w-full max-w-sm bg-white border border-orange-300 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center">
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link to={`/details/${id}`} className="text-white bg-orange-700 hover:bg-blue-800 focus:ring-3 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Ver más
          </Link>
        </div>
      </div>
